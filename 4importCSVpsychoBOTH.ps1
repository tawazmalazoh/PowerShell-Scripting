...
$FormattedCSVFile = 'C:\DATA\Briefcase\Formatted\psycho_7.csv'
...
$SQLQuery = "INSERT INTO psycho_7 (hhkey,
hhmem_key,
Q301,
Q302,
Q303,
...
'$METAKEY')"
 ...
 $InfoMessage = "Successfully imported $count Psyco Qstns into the YZ-UHP CLOUD database" 
 Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
