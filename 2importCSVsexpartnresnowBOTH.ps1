...
$SourceCSVFile = 'C:\DATA\Briefcase\BriefcaseDownloads\Baseline_INDVQ-manypartners.csv'
$FormattedCSVFile = 'C:\DATA\Briefcase\Formatted\sexpartnresnow_7.csv'
...
Select  -Property   @{Name="Q226";Expression={$_."Q226"}},
      @{Name="Q227";Expression={$_."Q227"}},
      @{Name="Q228";Expression={$_."Q228"}},
      @{Name="Q229";Expression={$_."Q229"}},
      @{Name="Q230";Expression={$_."Q230"}},
      @{Name="Q231";Expression={$_."Q231"}},
      @{Name="Q232";Expression={$_."Q232"}},
      @{Name="Q233";Expression={$_."Q233"}},
      @{Name="Q234";Expression={$_."Q234"}},
      @{Name="Q234other";Expression={$_."Q234other"}},
      @{Name="Q235";Expression={$_."Q235"}},
...
$Q233= $i.Q233
$Q234= $i.Q234
$Q234other= $i.Q234other.replace("'","")
$Q235= $i.Q235
$PARENT_KEY= $i.PARENT_KEY
$METAKEY= $i.METAKEY

$SQLQuery = "INSERT INTO sexpartnresnow_7 ( Q226,
Q227,
Q228,
Q229,
Q230,
...
'$METAKEY')"
 ...
 $impcsv = invoke-sqlcmd -Username $LocalDatabaseUser -Password $LocalDatabasePWD -Database $LocalDatabaseName -Query $SQLQuery  -serverinstance $LocalSQLServerInstance  
        $InfoMessage = " $METAKEY successfully uploaded to YZ-UHP Local MSSSQL Server."  
        Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
 
  $count  = $count + 1 
 
 } 
 $InfoMessage = "Successfully imported $count SEXPARTNOW  Qstns into the YZ-UHP database" 
 Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
...
'$METAKEY')"
       ...
       # Cloud Database Settings
        ...
        $InfoMessage = "$METAKEY successfully uploaded to Cloud YZ-UHP database on SmarterASP."  
        Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
 ...
 $InfoMessage = "Successfully imported $count SEXPARTNOW Qstns into the YZ-UHP CLOUD database" 
 Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
