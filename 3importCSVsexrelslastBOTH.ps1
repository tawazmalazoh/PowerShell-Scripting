...
$SourceCSVFile = 'C:\DATA\Briefcase\BriefcaseDownloads\Baseline_INDVQ-sexpartners.csv'
$FormattedCSVFile = 'C:\DATA\Briefcase\Formatted\sexrelslast_7.csv'
...
$LogFile = $LogFileFolder+'log-'+$date+'-sexrelslast_7.log'
...
Select  -Property   @{Name="Q421";Expression={$_."Q421"}},
      @{Name="Q422";Expression={$_."Q422"}},
      @{Name="Q423";Expression={$_."Q423"}},
      @{Name="Q424";Expression={$_."Q424"}},
      @{Name="Q425";Expression={$_."Q425"}},
      @{Name="Q426";Expression={$_."Q426"}},
      @{Name="Q427";Expression={$_."Q427"}},
      @{Name="Q428";Expression={$_."Q428"}},
      @{Name="Q429";Expression={$_."Q429"}},
      @{Name="Q430";Expression={$_."Q430"}},
      @{Name="Q431";Expression={$_."Q431"}},
...
$SQLQuery = "INSERT INTO sexrelslast_7 (Q421,
Q422,
Q423,
Q424,
Q425,
...
'$METAKEY')"
 ...
 $InfoMessage = "Successfully imported $count SEXRELS LAST3  Qstns into the YZ-UHP database" 
 Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
...
'$METAKEY')"
  ...
  $InfoMessage = "Successfully imported $count SEXRELSLAST Qstns into the YZ-UHP CLOUD database" 
 Write-Log -Message $InfoMessage -Path $LogFile   -Level Info
